...
if ( isset( $_GET['machines'] ) ) {
    $machine_ids = array_map( 'absint', explode( ',', sanitize_text_field( wp_unslash( $_GET['machines'] ) ) ) );
    $compare_args['post__in'] = $machine_ids;
...
<section class="bg-gray-900 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <?php if ( ! empty( $machines_data ) ) : ?>
            <div class="flex justify-end mb-8">
                <a href="<?php echo esc_url( get_post_type_archive_link( 'machines' ) ); ?>" class="inline-flex items-center px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded transition-colors border border-gray-700">
                ...
                <table class="w-full min-w-[800px] bg-gray-800 rounded-lg overflow-hidden border border-gray-700">
                    <thead>
                        <tr class="bg-gray-900 border-b border-gray-700">
                            ...
                            <?php foreach ( $machines_data as $machine ) : ?>
        ...
        <?php else : ?>
            <div class="text-center py-16">
                ...
                <a href="<?php echo esc_url( get_post_type_archive_link( 'machines' ) ); ?>" class="inline-flex items-center px-8 py-4 bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-bold rounded transition-colors font-rajdhani tracking-wide">
