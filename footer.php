			...
			<div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_repeat(3,minmax(0,0.63fr))] gap-10">
				<div class="max-w-md">
					...
					<p class="text-slate-300 leading-relaxed mb-6">
						<?php esc_html_e( 'A conversion-focused industrial machine theme built around one clear route: browse, compare, decide, then quote or buy with confidence.', 'industrial-welding' ); ?>
					</p>
				...
				<div>
					...
					<ul class="space-y-3 text-slate-400">
						...
						<li><a href="<?php echo esc_url( $contact_url ); ?>" class="transition hover:text-amber-200"><?php esc_html_e( 'Documentation Request', 'industrial-welding' ); ?></a></li>
						<li><a href="<?php echo esc_url( $contact_url ); ?>" class="transition hover:text-amber-200"><?php esc_html_e( 'Bulk Quote', 'industrial-welding' ); ?></a></li>
					</ul>
				</div>
