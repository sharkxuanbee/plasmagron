...
$page_summary = __( 'Use this fallback post index when WordPress resolves to the generic template hierarchy. The route still stays inside the industrial article system.', 'industrial-welding' );
?>
...
<section class="relative overflow-hidden bg-slate-950">
	...
	<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
		<div class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-8 items-start">
			<div class="max-w-4xl">
				<p class="text-xs uppercase tracking-[0.34em] text-amber-300 font-semibold mb-4"><?php esc_html_e( 'Post Index Fallback', 'industrial-welding' ); ?></p>
				<h1 class="text-4xl md:text-5xl xl:text-6xl font-bold text-white font-rajdhani leading-none"><?php echo esc_html( $page_title ); ?></h1>
			...
			<div class="rounded-[1.8rem] border border-slate-800 bg-slate-900/80 p-6 shadow-[0_24px_55px_rgba(2,6,23,0.42)]">
				...
				<p class="mt-4 text-sm text-slate-300 leading-relaxed"><?php esc_html_e( 'This generic index template now works as a clean content fallback instead of exposing the old starter-theme layout when no more specific template wins.', 'industrial-welding' ); ?></p>
			</div>
		</div>
	</div>
</section>
...
<section class="bg-slate-950">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
		<div class="rounded-[1.8rem] border border-slate-800 bg-slate-900/78 p-8 shadow-[0_24px_55px_rgba(2,6,23,0.42)]">
			<p class="text-xs uppercase tracking-[0.3em] text-amber-300 font-semibold mb-3"><?php esc_html_e( 'Next Action', 'industrial-welding' ); ?></p>
			<h2 class="text-3xl font-bold text-white font-rajdhani"><?php esc_html_e( 'Use product routes when the goal is machine selection', 'industrial-welding' ); ?></h2>
