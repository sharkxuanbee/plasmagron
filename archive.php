...
<section class="relative overflow-hidden bg-slate-950">
	...
	<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
		<div class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-8 items-start">
			<div class="max-w-4xl">
				<p class="text-xs uppercase tracking-[0.34em] text-amber-300 font-semibold mb-4"><?php esc_html_e( 'Archive', 'industrial-welding' ); ?></p>
				<h1 class="text-4xl md:text-5xl xl:text-6xl font-bold text-white font-rajdhani leading-none"><?php echo esc_html( $title ); ?></h1>
				<?php if ( $description ) : ?>
					<p class="mt-5 max-w-3xl text-lg md:text-xl text-slate-300 leading-relaxed"><?php echo esc_html( $description ); ?></p>
				<?php endif; ?>
			...
			<div class="rounded-[1.8rem] border border-slate-800 bg-slate-900/80 p-6 shadow-[0_24px_55px_rgba(2,6,23,0.42)]">
				...
				<p class="mt-4 text-sm text-slate-300 leading-relaxed"><?php esc_html_e( 'Category, date, author, and generic archives now share the same industrial archive shell instead of falling into the legacy starter-theme layout.', 'industrial-welding' ); ?></p>
			</div>
		</div>
	</div>
</section>
